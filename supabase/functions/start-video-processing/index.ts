...
const cloudConvertJob = {
  tasks: {
    'import-video': { operation: 'import/url', url: signedUrlData.signedUrl, filename: rawFilePath.split('/').pop() },
    'transcode-1080p': { operation: 'convert', input: 'import-video', output_format: 'mp4', engine: 'ffmpeg', video_codec: 'x264', crf: 23, preset: 'medium', fit: 'scale', width: 1920, audio_codec: 'aac', audio_bitrate: 128 },
    'transcode-720p': { operation: 'convert', input: 'import-video', output_format: 'mp4', engine: 'ffmpeg', video_codec: 'x264', crf: 25, preset: 'medium', fit: 'scale', width: 1280, audio_codec: 'aac', audio_bitrate: 128 },
    'transcode-480p': { operation: 'convert', input: 'import-video', output_format: 'mp4', engine: 'ffmpeg', video_codec: 'x264', crf: 28, preset: 'medium', fit: 'scale', width: 854, audio_codec: 'aac', audio_bitrate: 96 },
    'export-1080p': { operation: 'export/url', input: 'transcode-1080p', inline: false, archive_multiple_files: false },
    'export-720p': { operation: 'export/url', input: 'transcode-720p', inline: false, archive_multiple_files: false },
    'export-480p': { operation: 'export/url', input: 'transcode-480p', inline: false, archive_multiple_files: false },
  },
